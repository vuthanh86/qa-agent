...
export function flattenWorkItemFields(fields) {
...
const PARAMETERIZED_STRING_PATTERN = /<parameterizedString\b[^>]*>([\s\S]*?)<\/parameterizedString>/gi;
/**
 ...
 */
export function parseTestSteps(stepsXml) {
    if (!stepsXml)
        return [];
    const steps = [];
...
export function normalizeOutcome(outcome) {
    ...
    if (normalized === "unspecified" || normalized === "none")
        return null;
    return outcome;
}
//# sourceMappingURL=work-item-fields.js.map