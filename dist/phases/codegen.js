 ...
 */
import { getDiffFiles, getDiffContent, classifyPath, getLastCommitMessage, parseDiffScope } from "../utils/git.js";
...
export function runCodegen(options) {
    ...
    lines.push("");
    if (depth === "smoke")
        lines.push("- all P0 PASS, no S1");
    else if (depth === "core")
        lines.push("- P0-P1 PASS, no S1/S2");
    else
        lines.push("- no open S1/S2; justified P2/P3 exceptions");
    lines.push("");
